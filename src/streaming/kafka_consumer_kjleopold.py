...
Authors: Denise Case, Kellie Leopold
Date: 2026-05
...
from streaming.data_engineering.derived_fields_kjleopold import enrich_message
from streaming.data_validation.data_contract_kjleopold import (
    CONSUMED_FIELDNAMES,
    SALES_REQUIRED_FIELDS,
    validate_required_fields,
)
from streaming.storage.storage_kjleopold import (
    init_db,
    log_storage_summary,
    write_valid_record,
)
from streaming.visualizations.live_visualizations_kjleopold import (
    close_live_chart,
    init_live_chart,
    save_live_chart,
    update_live_chart,
...
OUTPUT_CSV: Final[Path] = OUTPUT_DIR / "consumed_sales_kjleopold.csv"
OUTPUT_DB: Final[Path] = OUTPUT_DIR / "sales.duckdb_kjleopold"
OUTPUT_CHART: Final[Path] = OUTPUT_DIR / "sales_chart_kjleopold.png"
...
def process_message(
    ...
    *,
    ...
    LOG.info(
        ...
        f"customer_value={enriched['customer_value']}  "
